...
class Gex2Object {
    ...
    get_mesh() {
        if(this.model == null){
            // Load model data; this is from gex 3 and thus not compatible, mostly.
            ...
            //    vertices.push(new Gex2ObjectVertex(this.ObjData, vertexOffset, vertexColorOffset));
            //}
            //
            //var materials = {};
            //var geometries = {};
